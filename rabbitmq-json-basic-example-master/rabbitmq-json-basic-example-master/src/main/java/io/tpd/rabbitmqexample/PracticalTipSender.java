...
public class PracticalTipSender {
	...
	@Scheduled(fixedDelay = 3000L)
        ...
        rabbitTemplate.convertAndSend(RabbitMQConfig.EXCHANGE_NAME, RabbitMQConfig.Blood_Pressure, tip);
	 ...
	 */
        ...
        rabbitTemplate.convertAndSend(RabbitMQConfig.EXCHANGE_NAME, RabbitMQConfig.Heart_rate, tip);
        log.info("Practical Tip sent");
	 } 
    ...
    rabbitTemplate.convertAndSend(RabbitMQConfig.EXCHANGE_NAME, RabbitMQConfig.Blood_oxygen_level, tip);
    log.info("Practical Tip sent");
